...
typedef struct NPatchInfo {
    RayRectangle sourceRec;   // Region in the texture
...
RLAPI void RayUnhideWindow(void);                                    // Show the window
RLAPI void RayHideWindow(void);                                      // Hide the window
...
RLAPI void DrawRectangleLinesEx(RayRectangle rec, int lineThick, Color color);                              // Draw rectangle outline with extended parameters
...
RLAPI void DrawRectangleRoundedLines(RayRectangle rec, float roundness, int segments, int lineThick, Color color); // Draw rectangle with rounded edges outline
...
RLAPI void SetShapesTexture(Texture2D texture, RayRectangle source);                                        // Define default texture used to draw shapes
...
RLAPI void ImageDrawRectangle(Image *dst, RayRectangle rec, Color color);                                   // Draw rectangle within an image
...
RLAPI void DrawTextureRec(Texture2D texture, RayRectangle sourceRec, Vector2 position, Color tint);         // Draw a part of a texture defined by a rectangle
...
RLAPI void DrawTexturePro(Texture2D texture, RayRectangle sourceRec, RayRectangle destRec, Vector2 origin, float rotation, Color tint);       // Draw a part of a texture defined by a rectangle with 'pro' parameters
RLAPI void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, RayRectangle destRec, Vector2 origin, float rotation, Color tint);  // Draws a texture (or part of it) that stretches or shrinks nicely
...
RLAPI Image GenImageFontAtlas(const CharInfo *chars, RayRectangle **recs, int charsCount, int fontSize, int padding, int packMethod);  // Generate image font atlas using chars info
...
RLAPI void DrawTextRec(Font font, const char *text, RayRectangle rec, float fontSize, float spacing, bool wordWrap, Color tint);   // Draw text using font inside rectangle limits
RLAPI void DrawTextRecEx(Font font, const char *text, RayRectangle rec, float fontSize, float spacing, bool wordWrap, Color tint,
...
RLAPI void DrawBillboardRec(Camera camera, Texture2D texture, RayRectangle sourceRec, Vector3 center, float size, Color tint); // Draw a billboard texture defined by sourceRec
